...
test\test_APIHome.py FFFFFFFFFFFF                                                                                        [ 13%]
...
test\Services\test_Auth.py ...FFFFF                                                                                      [ 73%]
...
E       KeyError: 'authenticated'

test\test_APIHome.py:61: KeyError
...
self = <jwt.api_jws.PyJWS object at 0x00000290ADB766D0>, jwt = b'validtoken'
...
venv\lib\site-packages\jwt\api_jws.py:220: ValueError

The above exception was the direct cause of the following exception:

args = (), kwargs = {}, data = 'Bearer validtoken'
...
self = <jwt.api_jwt.PyJWT object at 0x00000290ADB76D90>, jwt = b'validtoken', key = '', algorithms = None
options = {'verify_signature': False}, kwargs = {}
...
venv\lib\site-packages\jwt\api_jwt.py:129:
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 

self = <jwt.api_jwt.PyJWT object at 0x00000290ADB76D90>, jwt = b'validtoken', key = '', algorithms = None
options = {'verify_aud': False, 'verify_exp': False, 'verify_iat': False, 'verify_iss': False, ...}, kwargs = {}
...
venv\lib\site-packages\jwt\api_jwt.py:100:
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 

self = <jwt.api_jws.PyJWS object at 0x00000290ADB766D0>, jwt = b'validtoken', key = '', algorithms = None
options = {'verify_aud': False, 'verify_exp': False, 'verify_iat': False, 'verify_iss': False, ...}, detached_payload = None    
kwargs = {}, merged_options = {'verify_aud': False, 'verify_exp': False, 'verify_iat': False, 'verify_iss': False, ...}
...
venv\lib\site-packages\jwt\api_jws.py:171:
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
mock_get_all_roles = <MagicMock name='GetAllRoles' id='2820423113312'>
mock_get_logged_in_user = <MagicMock name='GetLoggedInUser' id='2820423145312'>
...
self = <Services.dboperations.dboperations object at 0x00000290AE5A54C0>, newsyssession = None
...
mock_move = <MagicMock name='move' id='2820434358960'>, mock_listdir = <MagicMock name='listdir' id='2820432410224'>
mock_makedirs = <MagicMock name='makedirs' id='2820430716640'>, mock_exists = <MagicMock name='exists' id='2820430863136'>      
...
test\test_APIHome.py:176: KeyError
...
self = <unittest.mock._patch object at 0x00000290AE16D7C0>
...
E           AttributeError: <module 'APIHome' from 'C:\\Sujith\\Projects\\SADRD\\FinanceIT_SADRD\\API\\APIHome.py'> does not have the attribute 'parentparser'
...
E       KeyError: 'ActionLogsData'

test\test_APIHome.py:110: KeyError
...
E       KeyError: 'RolesData'

test\test_APIHome.py:132: KeyError
...
mock_get_all_roles = <MagicMock name='GetAllRoles' id='2820430199440'>
...
E       KeyError: 'UsersData'

test\test_APIHome.py:123: KeyError
_________________________________________ TestAPIHome.test_get_import_types_exception _________________________________________ 

self = <test.test_APIHome.TestAPIHome testMethod=test_get_import_types_exception>
...
E       KeyError: 'ImportTypesData'

test\test_APIHome.py:80: KeyError
...
test\test_APIHome.py:72: KeyError
...
self = <unittest.mock._patch object at 0x00000290AE16D2E0>
...
self = <unittest.mock._patch object at 0x00000290ADBDDF70>
...
test\test_APIHome.py:142: KeyError
________________________________________ Test_Auth.test_token_required_empty_user_list ________________________________________

self = <test.Services.test_Auth.Test_Auth testMethod=test_token_required_empty_user_list>
mock_get_logged_in_user = <MagicMock name='GetLoggedInUser' id='2820423122800'>
mock_decrypt_token = <MagicMock name='DecryptToken' id='2820430858944'>

    @patch('Services.Auth.DecryptToken')
    @patch('Services.Auth.GetLoggedInUser')
    def test_token_required_empty_user_list(self, mock_get_logged_in_user, mock_decrypt_token):
        gvar.sadrdUsersList = []
...
>           response = test_route()
E           TypeError: <lambda>() missing 1 required positional argument: 'f'

test\Services\test_Auth.py:115: TypeError
...
mock_insert_actionLog = <MagicMock name='insert_actionLog' id='2820430716064'>
mock_decrypt_token = <MagicMock name='DecryptToken' id='2820423900800'>
...
test\Services\test_Auth.py:98: TypeError
________________________________________ Test_Auth.test_token_required_no_auth_header _________________________________________ 

self = <test.Services.test_Auth.Test_Auth testMethod=test_token_required_no_auth_header>
mock_decrypt_token = <MagicMock name='DecryptToken' id='2820422248576'>

    @patch('Services.Auth.DecryptToken')
    def test_token_required_no_auth_header(self, mock_decrypt_token):
        @auth.token_required
        def test_route():
            return jsonify({'message': 'Success'})
...
test\Services\test_Auth.py:83: TypeError
____________________________________________ Test_Auth.test_token_required_success ____________________________________________ 

self = <test.Services.test_Auth.Test_Auth testMethod=test_token_required_success>
mock_insert_actionLog = <MagicMock name='insert_actionLog' id='2820423890160'>
mock_get_logged_in_user = <MagicMock name='GetLoggedInUser' id='2820423704096'>
mock_decrypt_token = <MagicMock name='DecryptToken' id='2820432409120'>
...
test\Services\test_Auth.py:54: TypeError
_________________________________________ Test_Auth.test_token_required_unauthorized __________________________________________ 

self = <test.Services.test_Auth.Test_Auth testMethod=test_token_required_unauthorized>
mock_get_logged_in_user = <MagicMock name='GetLoggedInUser' id='2820432268304'>
mock_decrypt_token = <MagicMock name='DecryptToken' id='2820430719392'>

    @patch('Services.Auth.DecryptToken')
    @patch('Services.Auth.GetLoggedInUser')
    def test_token_required_unauthorized(self, mock_get_logged_in_user, mock_decrypt_token):
...
test\Services\test_Auth.py:71: TypeError
====================================================== warnings summary ======================================================= 
...
FAILED test/test_APIHome.py::TestAPIHome::test_authenticate_user_no_token - KeyError: 'authenticated'
...
FAILED test/test_APIHome.py::TestAPIHome::test_close_tax_year_success - KeyError: 'status'
FAILED test/test_APIHome.py::TestAPIHome::test_cusip_mapping_data_success - AttributeError: <module 'APIHome' from 'C:\\Sujith\\Projects\\SADRD\\FinanceIT_SADRD\\API\\APIHome.py'> does not have the a...
FAILED test/test_APIHome.py::TestAPIHome::test_get_action_logs_success - KeyError: 'ActionLogsData'
FAILED test/test_APIHome.py::TestAPIHome::test_get_all_roles_success - KeyError: 'RolesData'
FAILED test/test_APIHome.py::TestAPIHome::test_get_all_user_details_success - KeyError: 'UsersData'
FAILED test/test_APIHome.py::TestAPIHome::test_get_import_types_exception - KeyError: 'ImportTypesData'
FAILED test/test_APIHome.py::TestAPIHome::test_get_import_types_success - KeyError: 'ImportTypesData'
FAILED test/test_APIHome.py::TestAPIHome::test_import_data_exception - AttributeError: <module 'APIHome' from 'C:\\Sujith\\Projects\\SADRD\\FinanceIT_SADRD\\API\\APIHome.py'> does not have the a...
FAILED test/test_APIHome.py::TestAPIHome::test_import_data_success - AttributeError: <module 'APIHome' from 'C:\\Sujith\\Projects\\SADRD\\FinanceIT_SADRD\\API\\APIHome.py'> does not have the a...
FAILED test/test_APIHome.py::TestAPIHome::test_update_user_success - KeyError: 'status'
FAILED test/Services/test_Auth.py::Test_Auth::test_token_required_empty_user_list - TypeError: <lambda>() missing 1 required positional argument: 'f'
FAILED test/Services/test_Auth.py::Test_Auth::test_token_required_invalid_token - TypeError: <lambda>() missing 1 required positional argument: 'f'
FAILED test/Services/test_Auth.py::Test_Auth::test_token_required_no_auth_header - TypeError: <lambda>() missing 1 required positional argument: 'f'
FAILED test/Services/test_Auth.py::Test_Auth::test_token_required_success - TypeError: <lambda>() missing 1 required positional argument: 'f'
FAILED test/Services/test_Auth.py::Test_Auth::test_token_required_unauthorized - TypeError: <lambda>() missing 1 required positional argument: 'f'
========================================= 17 failed, 69 passed, 10 warnings in 11.75s ========================================= 
